...
y_values = [5363, 151, 10, 15, 4]
plt.bar(x_values, y_values)
ax.set_xticks(range(len(protection_counts)))
ax.set_xticklabels(['No Intervention','Species of Concern','Threatened','Endangered','In Recovery'])
plt.ylabel('Number of Species')
plt.title('Conservation Status by Species')

rects = ax.patches
labels = [5363, 151, 15, 10, 4]
